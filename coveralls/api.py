...
def post(url, repo_token, service_job_id, service_name, git, source_files, parallel, skip_ssl_verify):
    json_file = build_file(repo_token, service_job_id, service_name, git, source_files, parallel)
    return requests.post(url, files={'json_file': json_file}, verify=skip_ssl_verify)
